...
// import { BackgroundGradientAnimation } from "./GradientBg"; // We might implement this later if needed, for now optional
// import Globe from "./Globe"; // Optional globe component
